package com.example.android2homework28.ui.fragments.singup
...
import com.example.android2homework28.databinding.FragmentSingUpBinding
...
class SingUpFragment : Fragment() {
    ...
    // тут все файберс вход через гугол
    ...
    private fun updateUI(user: FirebaseUser?) {
        if (user != null){
            ...
            Toast.makeText(requireContext(), "Аутентификация не удалась", Toast.LENGTH_SHORT).show().show()
        }
    }
}